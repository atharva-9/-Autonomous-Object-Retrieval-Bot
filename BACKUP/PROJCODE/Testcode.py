...
def Move (degs):
    radar = DigitalInputDevice(17, pull_up=False, bounce_time=2)
    while True:
...
#    videostream2 = VideoStream(resolution=(imW,imH),framerate=60).start()
    time.sleep(1)
